...
# ---------------------------------------------------------------------------
# Starting workflow: Clean Bash
# ---------------------------------------------------------------------------
log INFO 'Starting workflow: Clean Bash'

# ---------------------------------------------------------------------------
# Step 1 (bash): Inspect clone
# ---------------------------------------------------------------------------
step_inspect_clone() {
...
run_step step_inspect_clone

# ---------------------------------------------------------------------------
# Workflow finished: Clean Bash
# ---------------------------------------------------------------------------
log INFO 'Workflow finished: Clean Bash'
