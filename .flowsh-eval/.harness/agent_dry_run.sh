...
# ---------------------------------------------------------------------------
# Starting workflow: Agent Dry Run
# ---------------------------------------------------------------------------
log INFO 'Starting workflow: Agent Dry Run'

# ---------------------------------------------------------------------------
# Step 1 (agent): Ask default agent dry run only
# ---------------------------------------------------------------------------
step_ask_default_agent_dry_run_only() {
  local prompt
  prompt=$(cat <<'PROMPT_EOF'
Say one short sentence about this repository. Do not modify files.
PROMPT_EOF
  )
  run_agent "$prompt"
}
run_step step_ask_default_agent_dry_run_only

# ---------------------------------------------------------------------------
# Workflow finished: Agent Dry Run
# ---------------------------------------------------------------------------
log INFO 'Workflow finished: Agent Dry Run'
