...
# ---------------------------------------------------------------------------
# Starting workflow: Agent Real
# ---------------------------------------------------------------------------
log INFO 'Starting workflow: Agent Real'

# ---------------------------------------------------------------------------
# Step 1 (agent): Ask custom test agent
# ---------------------------------------------------------------------------
step_ask_custom_test_agent() {
  local prompt
  prompt=$(cat <<'PROMPT_EOF'
What is your name? Reply in under 20 words and do not modify files.
PROMPT_EOF
  )
  local agent='test'
  run_agent "$prompt" "$agent"
}
run_step step_ask_custom_test_agent

# ---------------------------------------------------------------------------
# Workflow finished: Agent Real
# ---------------------------------------------------------------------------
log INFO 'Workflow finished: Agent Real'
