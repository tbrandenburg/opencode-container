...
SCRIPT_NAME='vars_agent_expand.sh'
...
# ---------------------------------------------------------------------------
# Starting workflow: Vars Agent Expand
# ---------------------------------------------------------------------------
log INFO 'Starting workflow: Vars Agent Expand'

# ---------------------------------------------------------------------------
# Step 1 (vars): Capture README heading
# ---------------------------------------------------------------------------
step_capture_readme_heading() {
  local status=0
...
run_stateful_step step_capture_readme_heading

# ---------------------------------------------------------------------------
# Step 2 (agent): Ask custom test agent with vars
# ---------------------------------------------------------------------------
step_ask_custom_test_agent_with_vars() {
  local prompt
  prompt=$(cat <<PROMPT_EOF
The README heading is: ${README_HEADING}
Reply with your agent name and the heading. Do not modify files.
PROMPT_EOF
  )
  local agent='test'
  run_agent "$prompt" "$agent"
}
run_step step_ask_custom_test_agent_with_vars

# ---------------------------------------------------------------------------
# Workflow finished: Vars Agent Expand
# ---------------------------------------------------------------------------
log INFO 'Workflow finished: Vars Agent Expand'
